...
function GetCellValues() {
  ...
  burstTime = burstTime.trim(); // Removing the extra spaces from the input string
  burstTime = burstTime.split(" "); // Splitting the numbers of the input string
  burstTime = burstTime.filter((num) => num.trim() != " "); // Removing the extra spaces in between the input string
  burstTime = burstTime.filter((num) => Number(num) > 0); // Removing the negative numbers from the input string

  // Adjusting the array of arrival time
  arrivalTime = arrivalTime.trim(); // Removing the extra spaces from the input string
  arrivalTime = arrivalTime.split(" "); // Splitting the numbers of the input string
  arrivalTime = arrivalTime.filter((num) => num.trim() != ""); // Removing the extra spaces in between the input string
  arrivalTime = arrivalTime.filter((num) => Number(num) > -1); // Removing the negative numbers from the input string
